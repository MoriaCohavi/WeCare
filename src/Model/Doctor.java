...
public class Doctor extends User implements java.io.Serializable, CommandInterface {
	...
	//constructor
	public Doctor(String id, String managerId, long phone, String name, String email, String special,
	...
	public void updatePatientInfo(String patientId, int phone,int age, String email, int weight, int height, String gender, 
										String allergies, String subscriptions, String chronic_diseases) {
		if (search(patientId)) {
	...
	public boolean updatePatientInfo(String patientId, String email, long phone, String allergies, 
											String chronic_diseases, String subscriptions){
		if(search(patientId)) {
